...
{
    /// <summary>
    /// MSYSP002_Program 程式基本資料維護
    /// </summary>
    public class MSYSP002_ProgramController : BaseController
    {
        /// <summary>
        /// 資料列表
        /// </summary>
        ...
        public ActionResult Index(int page = 1, int pageSize = 10, string searchText = "")
        {
            ...
            using (z_repoPrograms repos = new z_repoPrograms())
            {
                ...
                var model = repos.GetDapperDataListAll(searchText).ToPagedList(page, pageSize);
        ...
        public ActionResult CreateEdit(int id = 0)
        {
            ...
            using (z_repoPrograms repos = new z_repoPrograms())
            {
                ...
                if (model == null)
                {
                    ...
                    {
                        model.IsEnabled = (bool)attr.GetDefaultValue<z_metaPrograms>("IsEnabled");
                        model.RoleNo = (string)attr.GetDefaultValue<z_metaPrograms>("RoleNo");
                        model.ModuleNo = (string)attr.GetDefaultValue<z_metaPrograms>("ModuleNo");
                        model.SortNo = (string)attr.GetDefaultValue<z_metaPrograms>("SortNo");
                        model.PrgNo = (string)attr.GetDefaultValue<z_metaPrograms>("PrgNo");
                        model.PrgName = (string)attr.GetDefaultValue<z_metaPrograms>("PrgName");
                        model.CodeNo = (string)attr.GetDefaultValue<z_metaPrograms>("CodeNo");
                        model.AreaName = (string)attr.GetDefaultValue<z_metaPrograms>("AreaName");
                        model.ControllerName = (string)attr.GetDefaultValue<z_metaPrograms>("ControllerName");
                        model.ActionName = (string)attr.GetDefaultValue<z_metaPrograms>("ActionName");
                        model.ParmValue = (string)attr.GetDefaultValue<z_metaPrograms>("ParmValue");
                        model.Remark = (string)attr.GetDefaultValue<z_metaPrograms>("Remark");
                    }
                }
                return View(model);
            }
        ...
        public ActionResult CreateEdit(Programs model)
        {
            ...
            {
                TempData["ErrorMessage"] = ActionService.SetErrorMessage<z_metaPrograms>(ModelState);
                return View(model);
            }
            using (z_repoPrograms repos = new z_repoPrograms())
            {
