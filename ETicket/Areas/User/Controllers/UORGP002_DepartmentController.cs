...
{
    /// <summary>
    /// UORGP002_Department 部門基本資料維護
    /// </summary>
    public class UORGP002_DepartmentController : BaseController
    {
        /// <summary>
        /// 資料列表
        /// </summary>
        ...
        public ActionResult Index(int page = 1, int pageSize = 10, string searchText = "")
        {
            ...
            using (z_repoDepartments repos = new z_repoDepartments())
            {
        ...
        [HttpPost]
        [LoginAuthorize()]
        public ActionResult CreateEdit(Departments model)
        {
