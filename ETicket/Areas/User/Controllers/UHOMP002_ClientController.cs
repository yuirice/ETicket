...
{
    /// <summary>
    /// UHOMP002_Client 產品代表客戶介紹
    /// </summary>
    public class UHOMP002_ClientController : BaseController
    {
        /// <summary>
        /// 資料列表
        /// </summary>
        ...
        public ActionResult Index(int page = 1, int pageSize = 10, string searchText = "")
        {
            ...
            using (z_repoClients repos = new z_repoClients())
            {
        ...
        [HttpPost]
        [LoginAuthorize()]
        public ActionResult CreateEdit(Clients model)
        {
